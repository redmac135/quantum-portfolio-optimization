...
def main():
    print(
        "This code creates a list of all the variables we will have, combining their tickers with their portfolio allocation."
    )
    ...
    print(
        "If the quantum results indicate that "
        + str(variableList[7])
        + " is 1, then we should buy that stock with that % of our portfolio. If the same stock is taken for more than one weighting, these will be summed. That is on the way."
    )
