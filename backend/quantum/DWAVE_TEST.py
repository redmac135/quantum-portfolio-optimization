...
import quantum.Finding_effective_weights as few
import time
from sympy import *
import numpy as np
import random as random
from quantum.returnsFormater import updateFinalLinearDic
from quantum.dwaveDataFormater import stock_values
from quantum.CovarianceFunctions import covariances, addCovariance
...
def main():
    ...
    two_variable_terms = multiply_dict_values(
        extract_variable_terms(expanded_expression), 3000
    )
